...
type LinkedIdentity = UserIdentity;
...
function getIdentityString(identity: LinkedIdentity, key: string) {
...
function identityDisplayName(identity: LinkedIdentity) {
  return (
    getIdentityString(identity, 'user_name') ??
    getIdentityString(identity, 'preferred_username') ??
    getIdentityString(identity, 'full_name') ??
    getIdentityString(identity, 'name') ??
    getIdentityString(identity, 'email') ??
    identity.provider
  );
}
                  ...
                  >
                    ...
                    {isLinked && linkedIdentity ? (
                      <button
                        ...
                        title={
                          identities.length < 2
                            ? 'You need at least one other sign-in method before disconnecting this provider.'
                            : undefined
                        }
